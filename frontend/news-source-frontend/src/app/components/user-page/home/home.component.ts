...
export class HomeComponent implements OnInit{
    ...
    ngOnInit(){
        this.retriveArticleCardsTest();
    }

    /* retriveArticleCards(): void {
        this.articleCardService.getAll()
        .subscribe({
            next: (data) => {
    ...
    retriveArticleCardsTest(): void {
        this.articleCardList = [{"title": 'Пари от REPowerEU може да се насочат към санирането',
